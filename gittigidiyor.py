...
if os.path.isfile(filename_store):
	with open(filename_store) as data_file:
		dataArray = []
	...
	with open(filename_store, mode='a+', encoding='utf-8') as feedsjson:
...
if not os.path.isfile(filename_store):
	while var < 1000:
		x = str(var)
